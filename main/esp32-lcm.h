...
// Backward-compatible aliases used by main.c
#define CUSTOM_OTA_TRIGGER HOMEKIT_CHARACTERISTIC_CUSTOM_OTA_TRIGGER

// HOMEKIT_CHARACTERISTIC_(name, ...) expects the suffix used by
// HOMEKIT_DECLARE_CHARACTERISTIC_<suffix>. So pass CUSTOM_OTA_TRIGGER (not
// HOMEKIT_CHARACTERISTIC_CUSTOM_OTA_TRIGGER).
